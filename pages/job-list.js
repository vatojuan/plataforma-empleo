...
export default function JobList() {
  ...
  const { user, role: userRole, token: sessionToken, authHeader: getNextAuthHeader, ready } =
    useAuthUser();
  ...
  const handleApply = async (jobId) => {
    ...
    try {
      console.log(
        "[JobList] handleApply POST",
        `${API_BASE}/api/job/apply`,
        jobId
      );
